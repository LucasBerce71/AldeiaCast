...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay" style="background-image: url(../images/fase3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">

          <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
            <h2 class="text-white font-weight-light mb-2 display-4">Terceira Fase</h2>
...
$result_consulta = "SELECT * FROM grupos WHERE Fase = 3 AND Ativo = 'A'";
...
?>
    ...
    <div class="site-blocks-cover overlay inner-page-cover" style="margin-top: 19px; background-image: url(../images/fase3.jpg);" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
